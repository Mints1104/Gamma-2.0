...
object DataMappings {
    ...
    val encounterList = listOf(
        Encounter("Bulbasaur"), Encounter("Charmander"), Encounter("Squirtle"), Encounter("Pidgey"),
        Encounter("Clefairy"), Encounter("Vulpix"), Encounter("Jigglypuff"), Encounter("Diglett"),
        Encounter("Meowth"), Encounter("Growlithe (Hisuian)"), Encounter("Growlithe"), Encounter("Poliwag"),
        Encounter("Abra"), Encounter("Slowpoke"), Encounter("Galarian Slowpoke"), Encounter("Farfetch'd"),
        Encounter("Doduo"), Encounter("Gastly"), Encounter("Exeggutor"), Encounter("Marowak"),
        Encounter("Chansey"), Encounter("Scyther"), Encounter("Magikarp"), Encounter("Eevee"),
        Encounter("Omanyte"), Encounter("Kabuto"), Encounter("Aerodactyl"), Encounter("Dratini"),
        Encounter("Sudowoodo"), Encounter("Sneasel"), Encounter("Teddiursa"), Encounter("Slugma"),
        Encounter("Remoraid"), Encounter("Houndour"), Encounter("Larvitar"), Encounter("Poochyena"),
        Encounter("Wingull"), Encounter("Ralts"), Encounter("Slakoth"), Encounter("Nincada"),
        Encounter("Skitty"), Encounter("Mawile"), Encounter("Aron"), Encounter("Spinda"),
        Encounter("Trapinch"), Encounter("Lileep"), Encounter("Anorith"), Encounter("Feebas"),
        Encounter("Snorunt"), Encounter("Clamperl"), Encounter("Bagon"), Encounter("Beldum"),
        Encounter("Bidoof"), Encounter("Shinx"), Encounter("Combee"), Encounter("Buneary"),
        Encounter("Glameow"), Encounter("Stunky"), Encounter("Gible"), Encounter("Hippopotas"),
        Encounter("Croagunk"), Encounter("Snover"), Encounter("Snivy"), Encounter("Tepig"),
        Encounter("Oshawott"), Encounter("Lillipup"), Encounter("Pidove"), Encounter("Blitzle"),
        Encounter("Roggenrola"), Encounter("Cottonee"), Encounter("Darumaka"), Encounter("Tirtouga"),
        Encounter("Archen"), Encounter("Trubbish"), Encounter("Vanillite"), Encounter("Elgyem"),
        Encounter("Axew"), Encounter("Cubchoo"), Encounter("Stunfisk"), Encounter("Bunnelby"),
        Encounter("Litleo"), Encounter("Espurr"), Encounter("Spritzee"), Encounter("Swirlix"),
        Encounter("Inkay"), Encounter("Binacle"), Encounter("Tyrunt"), Encounter("Amaura"),
        Encounter("Dedenne"), Encounter("Rowlet"), Encounter("Litten"), Encounter("Popplio"),
        Encounter("Stufful"), Encounter("Wimpod"), Encounter("Komala"), Encounter("Lechonk")
    )
